...
public class AdressBookSystem {
	 ...
	 */
	    ...
	    static HashMap<String, ArrayList<AdressBook>> hashmap = new HashMap<>();
	    static AdressBookSystem details = new AdressBookSystem();
	        ...
	        while (true) {
	            ...
	            switch (choose) {
	                case 1:
	                    ...
	                    ArrayList<AdressBook> new_address_book = new ArrayList<>();
	                ...
	                case 2:
	                    ...
	                    if (hashmap.containsKey(address_name_old)) {
	                        ...
	                        ArrayList<AdressBook> old_address_book = new ArrayList<>();
